...
const Glassmorphism = () => {
	return (
		<div className="flex flex-row justify-center items-center min-h-full bg-center bg-no-repeat bg-cover">
			<main
				className="flex flex-col lg:flex-row bg-[#21201d] bg-opacity-80 rounded-3xl overflow-hidden w-full max-w-5xl shadow-lg m-4 lg:m-6"
				style={{
					backdropFilter: 'blur(10px)',
				}}
			>
				...
				>
					...
					<a href="https://luanedcosta.github.io/react-tailwindcss-glassmorphism/">CLICK ON ME</a>

					<div className="text-purple-500 text-lg font-black flex items-center mb-2">
						{/* <FiUser /> */}
