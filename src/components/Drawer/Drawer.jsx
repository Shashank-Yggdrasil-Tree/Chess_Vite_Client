...
function ResponsiveDrawer(props) {
  ...
  const stockfishNavList = [
    { name: "Play Vs Friend", link: "playvfriend" },
    { name: "Engine Vs Engine", link: "stockstock" },
    { name: "Play Vs Comp", link: "playvcomp" },
    { name: "Styled", link: "styled" },
    { name: "3D ChessBoard", link: "ChessBoard3D" },
    { name: "Analysis Board", link: "analysis" },
    { name: "Home", link: "playvfriend" },
  ];
